...
- **CORS** — configurable via `TITEN_CORS_ORIGINS` environment variable. Only listed origins are allowed; malformed entries are silently skipped (no wildcard, no panic). Default: same-origin only.
