...
Titen is a small open-source project and we want it to stay a place people enjoy contributing to.
...
- **Stay on topic.** Issues, PRs, and discussions are about Titen. Take off-topic conversations elsewhere.
...
If you see a violation or experience one, email **hello@codecora.dev** with subject `[Titen conduct]`. Include links and context.
