...
CREATE INDEX IF NOT EXISTS idx_posts_scheduled ON posts(scheduled_id);
...
CREATE INDEX IF NOT EXISTS idx_analytics_post ON analytics_snap(post_id);
CREATE INDEX IF NOT EXISTS idx_analytics_time ON analytics_snap(snapshot_at);
...
CREATE INDEX IF NOT EXISTS idx_rate_account_action ON rate_tracking(account_id, action_type);
CREATE INDEX IF NOT EXISTS idx_rate_timestamp ON rate_tracking(timestamp);
